...
CREATE TABLE userInfo (ID INTEGER PRIMARY KEY, Username TEXT UNIQUE NOT NULL, Password TEXT, Salt TEXT, Alias TEXT, ResellerAlias TEXT, AuthMax INTEGER, AuthLeft INTEGER, DeauthLeft INTEGER, ResellerID INTEGER);
INSERT INTO userInfo VALUES(1,'root',NULL,NULL,NULL,NULL,2147483647,2147483647,2147483647,1);
CREATE TABLE resellerInfo (ID INTEGER PRIMARY KEY, Alias TEXT, AppTitle TEXT, AppStatus TEXT, AppCopyright TEXT);
INSERT INTO resellerInfo VALUES(1,'root','千里云打标系统',NULL,NULL);
