...
CREATE TABLE liveViewer (ID INTEGER PRIMARY KEY, UserID INTEGER NOT NULL, LiveID INTEGER NOT NULL, CustomerID INTEGER NOT NULL);
...
INSERT INTO liveViewer (ID, UserID, LiveID, CustomerID) VALUES (1, 1, 1, 1);
INSERT INTO liveViewer (ID, UserID, LiveID, CustomerID) VALUES (2, 1, 1, 2);
INSERT INTO liveViewer (ID, UserID, LiveID, CustomerID) VALUES (3, 1, 2, 2);
INSERT INTO liveViewer (ID, UserID, LiveID, CustomerID) VALUES (4, 1, 2, 3);
